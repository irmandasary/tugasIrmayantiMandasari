<%-- 
    ...
    Created on : Oct 18, 2017, 6:27:22 AM
    Author     : user
--%>
...
<div class="w3-top">
  <div class="w3-white w3-xlarge" style="max-width:1200px;margin:auto">
    ...
    <div class="w3-right w3-padding-16">Indocyber Shop</div>
    <div class="w3-center w3-padding-16">Detail Product</div>
  </div>
</div>
<script>
...
function w3_close() {
    ...
    <body>
        <br>
            ...
            <h3>Detail Product ${product.description} : </h3>
             <thead>
                 <tr class="success">
                    <th>Product Name</th>
                    <th>Purchase Cost</th>
